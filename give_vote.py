...
imgBackground = cv2.imread("th.jpg")
...
while True:
    ...
    if k ==ord('1'):
        ...
        if exist:
            ...
            with open("Votes" + ".csv", "+a") as csvfile:
                ...
                writer.writerow(attendence)
            csvfile.close()
        speak("thankyu for participating in the election")
        break
    ...
    if k ==ord('2'):
        ...
        if exist:
            with open("Votes" + ".csv", "+a") as csvfile:
                writer = csv.writer(csvfile)
                attendence = [output[0], "CONGRESS", date, timestamp]
                writer.writerow(attendence)
            csvfile.close()
        else:
            with open("Votes" + ".csv", "+a") as csvfile:
    ...
    if k ==ord('3'):
        ...
        if exist:
            with open("Votes" + ".csv", "+a") as csvfile:
                writer = csv.writer(csvfile)
                attendence = [output[0], "AAP", date, timestamp]
                writer.writerow(attendence)
            csvfile.close()
        else:
            with open("Votes" + ".csv", "+a") as csvfile:
    ...
    if k ==ord('4'):
        ...
        if exist:
            with open("Votes" + ".csv", "+a") as csvfile:
                writer = csv.writer(csvfile)
                attendence = [output[0], "NOTA", date, timestamp]
                writer.writerow(attendence)
            csvfile.close()
        else:
            with open("Votes" + ".csv", "+a") as csvfile:
